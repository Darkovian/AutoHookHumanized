...
public class TabConfigGuides : BaseTab
{
    ...
    private static void DrawDelayHook()
    {
        ...
        if (ImGui.InputInt(UIStrings.DrawConfigs_Min_, ref Service.Configuration.DelayBetweenHookMin, 0))
        {
            ...
            if (Service.Configuration.DelayBetweenHookMin > Service.Configuration.DelayBetweenHookMax)
            {
                (Service.Configuration.DelayBetweenHookMax, Service.Configuration.DelayBetweenHookMin) = (Service.Configuration.DelayBetweenHookMin, Service.Configuration.DelayBetweenHookMax);
            }
        ...
        if (ImGui.InputInt(UIStrings.DrawConfigs_Max_, ref Service.Configuration.DelayBetweenHookMax, 0))
        {
            ...
            if (Service.Configuration.DelayBetweenHookMax < Service.Configuration.DelayBetweenHookMin)
            {
                (Service.Configuration.DelayBetweenHookMin, Service.Configuration.DelayBetweenHookMax) = (Service.Configuration.DelayBetweenHookMax, Service.Configuration.DelayBetweenHookMin);
            }
    ...
    private static void DrawDelayCasts()
    {
        ...
        if (ImGui.InputInt(UIStrings.DrawConfigs_Min_, ref Service.Configuration.DelayBetweenCastsMin, 0))
        {
            ...
            if (Service.Configuration.DelayBetweenCastsMin > Service.Configuration.DelayBetweenCastsMax)
            {
                (Service.Configuration.DelayBetweenCastsMax, Service.Configuration.DelayBetweenCastsMin) = (Service.Configuration.DelayBetweenCastsMin, Service.Configuration.DelayBetweenCastsMax);
            }
        ...
        if (ImGui.InputInt(UIStrings.DrawConfigs_Max_, ref Service.Configuration.DelayBetweenCastsMax, 0))
        {
            ...
            if (Service.Configuration.DelayBetweenCastsMax < Service.Configuration.DelayBetweenCastsMin)
            {
                (Service.Configuration.DelayBetweenCastsMin, Service.Configuration.DelayBetweenCastsMax) = (Service.Configuration.DelayBetweenCastsMax, Service.Configuration.DelayBetweenCastsMin);
            }
