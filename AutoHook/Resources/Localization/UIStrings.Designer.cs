...
namespace AutoHook.Resources.Localization {
    ...
    internal class UIStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The maximum random ms added to the default 500ms between trying to autocast.
        /// </summary>
        internal static string MaxAutocastHumanization {
            get {
                return ResourceManager.GetString("MaxAutocastHumanization", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The minimum random ms added to the default 500ms between trying to autocast.
        /// </summary>
        internal static string MinAutocastHumanization {
            get {
                return ResourceManager.GetString("MinAutocastHumanization", resourceCulture);
            }
        }
